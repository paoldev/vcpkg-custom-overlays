...
if(z_vcpkg_icu_config_mode_args STREQUAL "")
    ...
    if("data" IN_LIST ARGS)
        find_library(ICU_DATA_LIBRARY_RELEASE NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_DATA_LIBRARY_DEBUG NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("dt" IN_LIST ARGS)
        find_library(ICU_DT_LIBRARY_RELEASE NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_DT_LIBRARY_DEBUG NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("i18n" IN_LIST ARGS)
        find_library(ICU_I18N_LIBRARY_RELEASE NAMES @WRAPPER_ICU_IN_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_I18N_LIBRARY_DEBUG NAMES @WRAPPER_ICU_IN_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("in" IN_LIST ARGS)
        find_library(ICU_IN_LIBRARY_RELEASE NAMES @WRAPPER_ICU_IN_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_IN_LIBRARY_DEBUG NAMES @WRAPPER_ICU_IN_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("io" IN_LIST ARGS)
        find_library(ICU_IO_LIBRARY_RELEASE NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_IO_LIBRARY_DEBUG NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("tu" IN_LIST ARGS)
        # optional, subject to icu[tools].
        find_library(ICU_TU_LIBRARY_RELEASE NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
        find_library(ICU_TU_LIBRARY_DEBUG NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    if("uc" IN_LIST ARGS)
        find_library(ICU_UC_LIBRARY_RELEASE NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH REQUIRED)
        find_library(ICU_UC_LIBRARY_DEBUG NAMES @WRAPPER_ICU_LIBS@ NAMES_PER_DIR PATHS "@WRAPPER_ICU_LIBS_PATH@" NO_DEFAULT_PATH)
    endif()
    cmake_policy(POP)
endif()
