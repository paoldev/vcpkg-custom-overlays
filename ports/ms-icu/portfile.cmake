...
if (EXISTS "${HEADERSPATH}\\icu.h" AND EXISTS "${LIBSPATH}\\icu.lib")
  message(STATUS "ICU found in Windows SDK version ${WINDOWS_SDK}.")
else()
  message(FATAL_ERROR "ICU not found in Windows SDK version ${WINDOWS_SDK}. Minimum required version is 10.0.18362.0.")
endif()
...
set(PKGCONFIG_ICU_LIBS "-licu")
set(WRAPPER_ICU_LIBS "icu")
set(WRAPPER_ICU_IN_LIBS "icu")
